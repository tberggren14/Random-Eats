...
struct RandomRestaurantView: View {
    ...
    private func getDirections(address: String){
...
struct RandomRestaurantView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        RandomRestaurantView(mealCloudKit: MealDataCloudKit(container: CKContainer(identifier: "iCloud.ICLOUD.RANDOM-EATS")), category: .constant("Restaurant"))
    }
}
